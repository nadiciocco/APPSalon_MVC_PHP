...
class Email {
    ...
    public function enviarCambioExitoso() {
        // Crear el objeto de email
        $mail = new PHPMailer();
        $mail->isSMTP();
        $mail->Host = $_ENV['EMAIL_HOST'];
        ...
        $contenido = "<html>";
        $contenido .= "<p><strong>Hola " . $this->nombre . "<strong> has cambiado tu password exitosamente. Puedes ingresar a tu cuenta desde el siguiente enlace.</p>";
        $contenido .= "<p>Presiona aquí: <a href='" . $_ENV['APP_URL'] ."'>Iniciar Sesión</a></p>";
        $contenido .= "</html>";
        $mail->Body = $contenido;
